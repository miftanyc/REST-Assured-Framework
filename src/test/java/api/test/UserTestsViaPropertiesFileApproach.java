...
import api.endpoints.UserEndPointsViaPropertiesFileApproach;
...
public class UserTestsViaPropertiesFileApproach {
    ...
    public void testPostUser(){
        ...
        Response response = UserEndPointsViaPropertiesFileApproach.createUser(userPayload);
    ...
    public void testGetUserByUsername(){
        ...
        Response response = UserEndPointsViaPropertiesFileApproach.readUser(this.userPayload.getUsername());
        response.then().log().body();
    ...
    public void testUpdateUserByUsername(){
        ...
        Response updateResponse = UserEndPointsViaPropertiesFileApproach.updateUser(this.userPayload, userPayload.getUsername());
    ...
    public void testDeleteUserByUsername(){
        ...
        Response response = UserEndPointsViaPropertiesFileApproach.deleteUser(this.userPayload.getUsername());
        response.then().log().body();
